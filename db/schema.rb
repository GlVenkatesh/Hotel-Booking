...
ActiveRecord::Schema.define(version: 2023_01_02_122430) do
  ...
  create_table "fixes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "check_in"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["room_id"], name: "index_fixes_on_room_id"
  ...
  create_table "orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.float "total_price"
    t.index ["fix_id"], name: "index_orders_on_fix_id"
